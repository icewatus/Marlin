...
#define STRING_CONFIG_H_AUTHOR "(ice, sapphireplus)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.4, 160.4, 800, 824 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 170, 170, 4, 70 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -45, 0.0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (155)    // X point for Z homing when homing all axes (G28).
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 2), (Y_MAX_POS - 150), 10 }
